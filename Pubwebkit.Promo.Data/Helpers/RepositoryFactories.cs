...
namespace Pubwebkit.Promo.Data.Helpers
{
    /// <summary>
    /// A maker of Pubwebkit Repositories.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Return the runtime Pubwebkit repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM PUBWEBKIT FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetPubwebkitFactories()
        {
        ...
        /// <summary>
        /// Constructor that initializes with runtime Pubwebkit repository factories
        /// </summary>
        public RepositoryFactories()
        {
            _repositoryFactories = GetPubwebkitFactories();
        }
